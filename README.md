...
**Sunken Reach** begins at the blue dive marker beside the safe landing beach on Sunwake Strand. Stand beside it and press **E** during the voyage. It is a 276 × 276 underwater realm with six regions: the Sunken Reach wreck, Coral Gardens, Kelp Hollows, Bell Sanctuary, Ember Vents, and Crown Graveyard. Below, **W/S** swims along your view, including up and down, and **A/D** strafes sideways. **Space** rises, **C** dives, and **Shift** swims faster; releasing movement leaves you hovering. Your normal blasters, Longshot scope, cutlass and healing pulse work underwater.

Explore twelve discoveries, swim close to collect nine caches, and choose from three cooperative events: ring the Bell Sanctuary chimes in any order, free the Kelp Hollows rays, or hold Crown Graveyard against four guards. The first wreck still has its three guards and chest, but it is only one stop: after it opens, the HUD points toward unfinished regions. The HUD names your local region, 3D objective distance, exploration counts, active-event progress, and the cyan return beacon distance. That beacon at the entry current remains available throughout the expedition; approach it and press **E** to return to shore. The island map marks the dive; while below, **M** opens the full regional chart with discoveries, caches, events, landmarks, local crew and local pings. The crew list labels friends who are ashore. Starting the lighthouse finale returns anyone below to shore and closes the dive for that voyage. See [UNDERWATER_ROLLOUT.md](docs/UNDERWATER_ROLLOUT.md) for the reproducible fixture and browser capture commands.
