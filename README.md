...
| F | Cutlass swing |
| E | Man or leave a deck cannon, use an airship lift or captured shrine to return to the boat, activate a shrine, restore the lighthouse, or revive a nearby friend |
...
To return, approach any captured shrine and press E: its inlaid runes and floating return marker light up cyan within reach, with an **E — Return to boat** prompt. The pale cyan lifts with brass rims and floating ↑ markers at Sunwake beach and beside Tideglass Lighthouse also remain available; both lifts are marked and named on the island map (M). Returning preserves health and equipment, and you stay aboard until you choose to jump. Manning a cannon also lets you stay after the opening flight. You can return and glide down again throughout the adventure.
